...
map.getView().fit([8528460.694055, 1037239.433229, 8542247.462046, 1045662.259531], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">aramula</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (53 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this is an administative map[ of aranmula panchayath ';
            }
